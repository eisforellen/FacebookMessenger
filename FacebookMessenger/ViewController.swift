...
class MessageCell: BaseCell {
    ...
    var message: Message? {
        didSet {
            ...
            if let date = message?.date {
                ...
                let secondsInDays: NSTimeInterval = 60 * 60 * 24
    ...
    let messageLabel: UILabel = {
        let label = UILabel()
        label.text = "Your friends message to you from facebooks..."
    ...
    override func setupViews() {
        ...
        profileImageView.image = UIImage(named: "ellen")
        hasReadImageView.image = UIImage(named: "ellen")
